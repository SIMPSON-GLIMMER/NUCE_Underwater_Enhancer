...
# ==========================
# VIDEO ENHANCEMENT SECTION (Final Stable Version)
# ==========================
import concurrent.futures
import time
...
if upload_type == "Video":
    ...
    if uploaded_video is not None:
        ...
        if not cap.isOpened():
            ...
            estimated = (total_frames / fps) * (frame_stride / 4)
            ...
            # Fill skipped frames with original frames
            ...
            # Double-check that file exists and is readable
            ...
            # Cleanup input file after playback
            os.remove(video_path)
